                ...
                <form action="<%=request.getContextPath()%>/choferes/alta" method="post">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" id="" class="form-control" value="${param.nombre}">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="apPaterno" id="" class="form-control" value="${param.apPaterno}">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="apMaterno" id="" class="form-control" value="${param.apMaterno}">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="licencia" id="" class="form-control" value="${param.licencia}">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" id="" class="form-control" value="${param.telefono}">
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fechaNacimiento" id="" class="form-control" value="${param.fechaNacimiento}">
                            <%
